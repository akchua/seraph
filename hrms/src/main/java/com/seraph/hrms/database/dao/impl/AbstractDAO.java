...
import com.seraph.hrms.database.dao.DAO;
import com.seraph.hrms.database.dao.base.SpringHibernateDAOSupport;
 ...
 * 
 * @see DAO
 * @see com.chua.distributions.database.dao.base.AbstractDAO
...
public abstract class AbstractDAO<T extends BaseID<ID>, ID extends Serializable>
		extends com.seraph.hrms.database.dao.base.AbstractDAO<T, ID>
		implements DAO<T, ID>
{
